...
#  insert your Site Key and Site Secret Key in the two variables below
 ...
 $recaptchaSiteKey =   '-hcaptcha-site-key-';   // your hCaptcha site key
 $recaptchaSecretKey = '-hcaptcha-secret-key-';   // your hCaptcha site secret key
...
print "<!-- contactH-inc.php V3.0` - 14-Apr-2020 -->\n";
?>
...
if(strpos($recaptchaSiteKey,'site-key-') > 0 or
   strpos($recaptchaSecretKey,'secret-key-') > 0) {
	 ...
	 $config_errors .= "valid hCaptcha keys set in this script to operate properly.</p>\n";
	 $config_errors .= "<p>Visit <a href=\"https://dashboard.hcaptcha.com/signup\" target=\"_blank\">";
	 $config_errors .= "https://dashboard.hcaptcha.com/signup</a> to acquire a Site and Secret hCaptcha key pair.</p>\n";
}
...
if( isset($_POST['h-captcha-response']) && !empty($_POST['h-captcha-response']) ) {
    ...
    $data = array(
		...
		$dataJ = http_build_query($data);
		$opts = array(
			'http' => array(
				'method' => 'POST',
				'header'=> "Content-type: application/x-www-form-urlencoded\r\n"
					. "Content-Length: " . strlen($dataJ) . "\r\n",
				'content' => $dataJ,
				'ssl' => array(
            'verify_peer' => false,
                ),
		...
		if($showDebug) {
		  print "<p class=\"advisoryBox\" style=\"text-align: left\">dataJ=".print_r($dataJ,true)."</p>\n";
		  print "<p class=\"advisoryBox\" style=\"text-align: left\">opts=".print_r($opts,true)."</p>\n";
		}

    $verifyResponse = file_get_contents('https://hcaptcha.com/siteverify',0,$context);
...
";
  ...
  $msg .= "hCaptcha response: ".$verifyResponse."\n\n";
...
<br />
<br />
<div class="h-captcha" data-sitekey="<?php echo $recaptchaSiteKey; ?>"></div>
<p>
...
<p style="text-align:center"><small>Contact script by <a href="https://saratoga-weather.org/scripts-contact.php">Saratoga-Weather.org</a><br/>
